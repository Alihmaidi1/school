                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input value="{{ $subject->getTranslation("Name","en") }}"  name="name_en" class="form-control">
                                    @error('name_en')
                                ...
                                <div class="col">
                                    ...
                                    <input name="name_ar" value="{{ $subject->getTranslation("Name","ar") }}"  class="form-control">
                                    @error('name_ar')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col">
                                    ...
                                    <select name="techer_id" class="form-control p-0">
                                        @foreach($techers as  $techer)
                                            <option @if($techer->id==$subject->teacher_id) selected @endif value="{{ $techer->id }}">{{ $techer->Name }}</option>
                                        @endforeach
