                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th>{{trans('subject.techer_name')}}</th>
                                        ...
                                        @foreach($subjects as $subject)
                                            ...
                                            <td>{{$subject->classroom->Name}}</td>
                                                <td>
                                                    ...
                                                    <a href="{{ route("subject_student",$subject->id) }}" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="fa fa-eye"></i></a>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p> {{ trans('subject.warning_subject') }}</p>                                                        </div>
