            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{ route("sheck.student.store") }}" method="post">
                             @csrf
                            <div class="form-row">
                                <div class="col">
                                ...
                                <div class="col">
                                    ...
                                    <select onchange="edit_amount()" id="select_amount"  name="student_fees" class="form-control p-0">
                                        @if($student_fee)
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input name="amount" id="amount" readonly value="{{ $first }}" class="form-control">
                                    @error('amount')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
