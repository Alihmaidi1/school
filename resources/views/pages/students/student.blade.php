                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{trans('student.Name_student')}}</th>
                                            <th>{{trans('student.Gender')}}</th>
                                            <th>{{trans('student.age')}}</th>
                                            <th>{{trans('student.classroom')}}</th>
                                            <th>{{ trans("student.process") }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php $i = 0; ?>
                                        ...
                                        @foreach($students as $student)
                                            ...
                                            <td>{{$student->section->classroom->Name}}</td>
                                                <td>
                                                    ...
                                                    <a href="{{ route("student.details",$student->id) }}" class="btn btn-warning btn-sm" role="button" aria-pressed="true"><i class="fa fa-eye"></i></a>
