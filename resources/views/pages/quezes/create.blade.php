...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route("queze.store") }}" enctype="multipart/form-data">
                @csrf
            <div class="container">
                ...
                <div class="row">
                    <div class="col-6">
                            ...
                            <div>
                                ...
                                <input name="first_answer" class="form-control"/>
                    ...
                    <div class="col-6">
                            ...
                            <div>
                                ...
                                <input class="form-control" name="second_answer"/>
                            </div>
                ...
                <div class="row">
                    <div class="col-6">
                            ...
                            <div>
                                ...
                                <input name="third_answer" class="form-control"/>
