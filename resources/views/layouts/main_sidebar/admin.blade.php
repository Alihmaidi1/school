        ...
        <div class="clearfix"></div>
                    ...
                    <li>
                        ...
                        <ul id="Grades-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('Grades.index')}}">{{trans('main_trans.classes')}}</a></li>
                    ...
                    <li>
                        ...
                        <ul id="classes-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("class_list") }}">{{ __("main_trans.classes_list") }} </a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("section") }}">{{ __("main_trans.section_list") }}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="students-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("show_parents") }}">{{ __("main_trans.parent_list") }} </a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("techer.show") }}">{{ __("main_trans.techer_list") }}</a> </li>
                            <li> <a href="{{ route("techer.salary_show") }}">{{ __("main_trans.salary_teacher") }}</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("show.student") }}"> {{ trans("main_trans.students_list") }} </a> </li>
                            <li> <a href="{{ route("promotion.index") }}"> {{ trans("main_trans.promotion") }} </a> </li>
                            <li> <a href="{{ route("promotion.graduate") }}"> {{ trans("main_trans.graduate") }} </a> </li>
                    ...
                    <li>
                        ...
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("show_subjects") }}">{{ __("main_trans.show_subjects") }} </a> </li>
                        </ul>
                    </li>

                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#1Accounts-menu">
                            <div class="pull-left"><i class="fas fa-money-bill-wave-alt"></i><span
                                    class="right-nav-text">{{trans('main_trans.fees')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="1Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("show_fees") }}">{{ __("main_trans.show_fees") }} </a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Attendance-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("attendace.show") }}">{{ trans("main_trans.Attendance_menu") }}</a> </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul id="Exams-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("show_exam") }}">{{ __("main_trans.Exams_menu") }}</a> </li>
                            <li> <a href="{{ route("show_queze") }}">{{ __("main_trans.queze") }}</a> </li>
                    ...
                    <li>
                        ...
                        <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ route("show_library") }}">{{ __("main_trans.library_menu") }}</a> </li>
                        </ul>
                    </li>
